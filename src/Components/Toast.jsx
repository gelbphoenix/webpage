import { Toast as ToastFB, ToastToggle } from 'flowbite-react';

const Toast = ({ content }) => {
  if (content.title === null || content.title === '') return null;

  return (
    <ToastFB className="fixed left-6 bottom-6 z-10 outline outline-stone-600 dark:outline-stone-300 text-[#001b5e] dark:text-stone-300">
